...
/**
 * Created by noelrs on 8/30/2016.
 */
...
public class SessionManager {
     ...
     * */
    public void createLoginSession(String id, String name, String apellidos, String email, String telefono){
        ...
        Log.d("Datos Sesion Guardados",editor.toString());
        // commit changes
        editor.commit();
    }
    ...
    //Guardar y Extraer datos para Detalle Psicologo
